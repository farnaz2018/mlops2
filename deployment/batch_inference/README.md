# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [mlops2/resources/README.md](../../resources/README.md)
...
df.write.mode("overwrite").saveAsTable(
    name="<catalog>.mlops2.feature_store_inference_input"
)
```
