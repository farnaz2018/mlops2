...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops2/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops2/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops2/validation/validation.py that returns model validation thresholds.
#
...
# COMMAND ----------
spark.sql("USE CATALOG dbdemos2")
spark.sql("USE SCHEMA mlops2")
...
dbutils.widgets.text("model_name", "dev.mlops2.mlops2-model", "Full (Three-Level) Model Name")
